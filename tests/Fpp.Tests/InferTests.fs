...
let private inferSrc (src : string) : Infer.InferResult =
    ...
    Infer.infer "test" p.Root b (Fpp.Prelude.dictNew ()) (Fpp.Prelude.dictNew ()) (Fpp.Prelude.dictNew ()) (Fpp.Prelude.dictNew ()) (Fpp.Prelude.dictNew ()) (Fpp.Prelude.dictNew ()) (Fpp.Prelude.dictNew ()) (Fpp.Prelude.dictNew ()) (Fpp.Prelude.dictNew ()) (Classes.newTables ())
