...
double c_sum_v2d(int32_t off, int32_t n) {
...
void c_scale_v2d(int32_t off, int32_t n, double k) {
    V2d *p = (V2d *)(fpp_mem_base() + off);
    for (int32_t i = 0; i < n; i++) { p[i].x *= k; p[i].y *= k; }
}

int32_t c_sum_i32(int32_t off, int32_t n) {
