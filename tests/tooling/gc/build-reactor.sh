...
emcc $SRCS -O2 -Igc/api -Igc/src -I. -DNDEBUG -DGC_PRECISE_ROOTS=1 \
  ...
  -s EXPORTED_FUNCTIONS='_fpprt_init,_fpprt_alloc,_fpprt_alloc_array,_fpprt_register_type_s,_fpprt_write_ref,_fpprt_safepoint,_fpprt_add_static_roots,_fpprt_allocated_bytes,_fpprt_frame_push,_fpprt_frame_pop,_fpprt_tid_of,_fpprt_wasm_roots_base,_fpprt_wasm_roots_register,_fpprt_tid2cid_base,_fpprt_wasm_refoffs_base,_fpprt_wasm_witness_base' \
