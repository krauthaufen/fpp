...
SPOT = [
    # the RESULT element must be WRITTEN: `constant (fun () -> ...)` does
    # not yet tie the HOF's element back to ^T, and an unascribed range
    # generalized with a second, unpinnable variable
